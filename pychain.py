...
text_sender = st.text_input('sender')

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
text_receiver = st.text_input('receiver')

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
text_amount = st.text_input('amount')
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(text_sender, text_receiver, text_amount),
        creator_id=42,
